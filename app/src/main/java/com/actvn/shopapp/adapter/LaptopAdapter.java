...
public class LaptopAdapter extends RecyclerView.Adapter<LaptopAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        Glide.with(context).load(laptop.getImgUrl())
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("imgs", laptop.getImgUrl());
                intent.putExtra("money", laptop.getCost() + "đ");
                intent.putExtra("name", laptop.getTitle());
